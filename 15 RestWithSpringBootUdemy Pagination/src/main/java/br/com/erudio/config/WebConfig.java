...
public class WebConfig implements WebMvcConfigurer {
	...
	public void configureContentNegotiation(ContentNegotiationConfigurer configurer) {
		...
		/*
		 * By Extension. Example=> localhost:8080/person.x-yaml
		...
		/*
		 * By Query Param. Example=> localhost:8080/person?mediaType=xml
		...
		/*
		 * YAML Support Example configurer.favorParameter(false)
		 * .ignoreAcceptHeader(false) .useRegisteredExtensionsOnly(false)
		 * .defaultContentType(MediaType.APPLICATION_JSON)
		 * .mediaType("json",MediaType.APPLICATION_JSON) .mediaType("xml",
		 * MediaType.APPLICATION_XML) .mediaType("x-yaml", MEDIA_TYPE_YML);
		 */
	}
}
